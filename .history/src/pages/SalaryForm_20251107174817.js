  ...
  const fetchData = async () => {
    try {
      const [membersRes, memberSalaryRes, positionsRes, salariesRes] =
       await Promise.all([axios.get("/member/list"), axios.get("/api/member-salaries"), axios.get("/api/position-salaries"), axios.get("/api/salaries/drafts"),]); setMembers(membersRes.data); setMemberSalaries(memberSalaryRes.data); setPositionSalaries(positionsRes.data); setList(salariesRes.data);
