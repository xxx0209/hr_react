              ...
              <Card.Body>
                {detailLoading ? (
                  ...
                  <>
                    ...
                    <p><strong>지급일:</strong> {selected.payDate}</p>
                    <p><strong>기본급:</strong> {selected.baseSalary?.toLocaleString()} 원</p>
                    <p><strong>시급:</strong> {selected.hourlyRate?.toLocaleString()} 원</p>
