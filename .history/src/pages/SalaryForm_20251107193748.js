...
export default function SalaryManager() {
  ...
  return (<div className="container mt-4"> <h3 className="mb-3">💰 급여 관리</h3> <Button variant="primary" onClick={handleShow}>+ 급여 등록</Button>
          ...
          <Row className="mb-3">
            <Col md={6}>
              <Form.Group>
                ...
                <Form.Control value={formatNumber(form.baseSalary)} readOnly />
              </Form.Group>
            </Col>
            <Col md={6}>
              <Form.Group>
                <Form.Label>시급</Form.Label>
                <Form.Control value={formatNumber(form.hourlyRate)} readOnly />
              </Form.Group>
            </Col>
          </Row>
