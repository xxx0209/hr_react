...
export default function SalaryManager() {
  ...
  const handleEdit = async (s) => {
    ...
    setForm({
      ...
      salaryMonth: s.salaryMonth || "",  // 기존 급여월 넣기
      payDate: s.payDate || "",
      status: s.status,
      availablePositionSalaries,       // 콤보 옵션 채우기
    });
    setShow(true);
  };
