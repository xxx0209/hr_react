...
export default function SalaryManager() {
  ...
  const handlePositionSalaryChange = (e) => {
    ...
    const positionSalary = form.availablePositionSalaries.find(ps => ps && ps.id === id);
  ...
  const handleEdit = (s) => {
      const availablePositionSalaries =
    s.salaryType === "POSITION" && s.member?.positionId
            ...
            <tr key={s.salaryId}>
              ...
              <td>
                ...
                <Button
                  ...
                  disabled={s.status === "COMPLETED"} // 이미 승인된 급여 비활성화
                >
                  승인
                </Button>
              </td>
              ...
              <Col md={6}>
                <Form.Group>
                  ...
                  <Form.Select
                    ...
                    required
                    disabled={!!form.salaryId} // 수정 시 회원 변경 불가
                  >
              ...
              <Col md={6}>
                <Form.Group>
                  ...
                  <Form.Select
                    ...
                    disabled={form.salaryType !== "POSITION"} // MEMBER는 선택 불가
                  >
                    <option value="">선택</option>
              ...
              <Col md={6}>
                <Form.Group>
                  ...
                  <Form.Control
                    ...
                    disabled={form.salaryType !== "POSITION"} // MEMBER는 수정 불가
                    required
                  />
                </Form.Group>
              </Col>
