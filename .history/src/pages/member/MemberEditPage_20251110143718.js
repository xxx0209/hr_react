...
export default function MemberEditPage() {
    ...
    const [errors, setErrors] = useState({
        name: '', password: '', confirmPassword: '', email: '', gender: '', address: '', general: ''
    });
                ...
                <Card.Body>
                    ...
                    <Form onSubmit={onSubmit}>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="text" name="name" value={form.name} onChange={onChange} required isInvalid={!!errors.name} />
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="password" name="password" value={form.password} onChange={onChange} placeholder="변경 시 입력" isInvalid={!!errors.password} />
                            <Form.Control.Feedback type="invalid">
                                {errors.password}
                            </Form.Control.Feedback>
                        </Form.Group>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="text" name="address" value={form.address} onChange={onChange} isInvalid={!!errors.address} />
                            <Form.Control.Feedback type="invalid">
                                {errors.address}
                            </Form.Control.Feedback>
                        </Form.Group>
