...
export default function MemberEditPage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const resMember = await axios.get(`/members/${user.memberId}`);
                setForm({ ...resMember.data, password: "", profileImage: null });

                // const resPositions = await axios.get("/categories"); // 직급 목록
                ...
                <Card.Body>
                    ...
                    <Form onSubmit={onSubmit}>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Select name="positionId" value={form.positionId || ""} onChange={onChange}>
                                <option value="">선택</option>
                                {positions.map((pos) => (
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="file" name="profileImage" onChange={onChange} />
                        </Form.Group>
