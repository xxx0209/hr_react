...
export default function SalaryManager() {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      memberSalaryId: form.salaryType === "MEMBER" ? Number(form.memberSalaryId) : null,
      positionSalaryId: form.salaryType === "POSITION" ? Number(form.positionSalaryId) : null,
      ...
      status: form.status,
      payDate: `${form.salaryMonth}-20`, // 서버 고정 지급일
    };
