...
function PositionSalaryPage() {
    ...
    const handleSave = async () => {
        ...
        const payload = {
            ...
            baseSalary: formData.baseSalary,import React from "react";
import { Tabs, Tab, Container } from "react-bootstrap";
import PositionSalaryPage from "./PositionSalaryPage";
import MemberSalaryPage from "./MemberSalaryPage";
...
export default SalarySettingPage;
        ...
        try {
            ...
            if (editing) {
                response = await axios.put(`/api/position-salaries/${formData.id}`, payload);
            } else {
                response = await axios.post('/api/position-salaries', payload);
            }
