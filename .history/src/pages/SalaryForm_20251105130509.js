...
export default function SalaryManager() {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      memberId: form.salaryType === "MEMBER" ? Number(form.memberId) : null,
      positionId: form.salaryType === "POSITION" ? Number(form.positionId) : null,
              ...
              <Col md={6}>
                {form.salaryType === "POSITION" ? (
                  <Form.Group>
                    ...
                    <Form.Select value={form.positionId} onChange={handlePositionSalaryChange}>
                  ...
                  <Form.Group>
                    ...
                    <Form.Select value={form.memberId} onChange={handleMemberSalaryChange}>
                      <option value="">선택</option>
