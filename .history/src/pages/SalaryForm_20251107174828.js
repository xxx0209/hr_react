    ...
    try {
      const [membersRes, memberSalaryRes, positionsRes, salariesRes] =
       await Promise.all([
        ...
        axios.get("/api/position-salaries"), axios.get("/api/salaries/drafts"),]); setMembers(membersRes.data); setMemberSalaries(memberSalaryRes.data); setPositionSalaries(positionsRes.data); setList(salariesRes.data);
