...
import PositionSalaryPage from '../pages/PositionSalaryPage';
    ...
    return (
        <Routes>
            ...
            <Route element={<PrivateLayoutRoute />}>
                ...
                <Route path="/salary/position-salary" element={<PositionSalaryPage />} />
                <Route path="/salary/salary-settings" element={<PositionSalaryPage />} />
